...
```mj
void*[]&()* ptr_to_fn_ret_ref_to_arr_of_ptr_to_void
```

```mj
n32* number
String(n32 size)* name
Box<f64>&[4] doubles
```
...
```mj
const n32 size  // constant n32
const n32* data // mutable pointer to constant n32
n32*const data // constant pointer to mutable n32
const n32*const data // constant pointer to constant n32
```
...
| Type   | Description |
| ------ | ----------- |
| `n8`   | Unsigned 8 bit integer         |
| `n16`  | Unsigned 16 bit integer        |
| `n32`  | Unsigned 32 bit integer        |
| `n64`  | Unsigned 64 bit integer        |
| `n128` | Unsigned 128 bit integer       |
...
| `c16`  | 16 bit complex floating point  |
| `c32`  | 32 bit complex floating point  |
| `c64`  | 64 bit complex floating point  |
| `c80`  | 80 bit complex floating point  |
| `c128` | 128 bit complex floating point |

```mj
// Actual implementation

// T is u8, u16, n32, or u64

// Z integer  types:  u8, u16, n32, u64, i8, i16, i32, i64
// R floating types:  f32, f64
// N unsigned types:  u8, u16, n32, u64
...
```mj
// {u8 *data; @shared const n32 SIZE = 4}
n8[4] array_of_4_u8
```
...
List<n32> list = new(7) // constructor
List<n32> list = [0, 1, 34, 65, 3] // implicit cast of array literal to iterable
