...
Mjolnir is a systems programming language with an emphasis on transparent memory
...
and with the computer architecture to achieve complete control and performance.
...
syntax for bit fields, register access, memory management, record structure,
...
Mjolnir places a strong emphasis on transparency and all syntax and design decisions
...
- Signed integers use only 2's compliment arithmetic
...
- Literals are not constants. They are temporaries.
