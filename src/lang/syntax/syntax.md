...
**Note:** Short circuit behavior applies to logical operators `and` and `or`,
...
A basic type augmented with `()`, `[]`, `&`, `*`, `^`, `?` and `!`.
...
- `^` **nullable pointer to...**
    This is denoted by the `^` character, and the pointer may be null.
- `[N]` **array of...**
- `[]` **slice of...**
...
- `()` **function returning...**
  ...
  "returning" void).
- `?` **maybe uninitialized or fallible function**
- `!` **uninitialized or no-return function**
...
List<n32> list = List<n32>(7); // constructor
...
// T is n8, n16, n32, or n64

// Z integer  types:  n8, n16, n32, n64, i8, i16, i32, i64
// R floating types:  f32, f64
// N unsigned types:  n8, n16, n32, n64
